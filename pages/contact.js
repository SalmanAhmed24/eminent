        ...
        <motion.h1
          ...
          variants={{
            ...
            visible: {
              opacity: 1,
              x: 0,
              transition: { delay: 1.03, ease: "easeInOut" },
            },
          }}
        >
          Get In Touch
        ...
        <motion.p
          ...
          variants={{
            ...
            visible: {
              opacity: 1,
              y: 0,
              transition: { delay: 1.045, ease: "easeInOut" },
            },
          }}
        >
        ...
        <motion.form
          ...
          variants={{
            ...
            visible: {
              opacity: 1,
              y: 0,
              transition: { delay: 1.06, ease: "easeInOut" },
            },
          }}
          className="formWrap"
        >
